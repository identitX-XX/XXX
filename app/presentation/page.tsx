...
export default function PresentationPage() {
  ...
  return (
    <div className="relative">
      {/* Halo chaud prune sur gris, raccord marque (fini le bleu délavé). */}
      <div
        aria-hidden
        className="pointer-events-none fixed inset-0 -z-10"
        style={{
          background:
            "radial-gradient(120% 75% at 50% 10%, color-mix(in srgb, var(--fuchsia) 9%, transparent), transparent 60%), var(--noir)",
        }}
      />
      ...
      {ecrans.map((e, i) => (
        <section
          ...
          className="flex min-h-[78vh] flex-col justify-center px-4 py-8"
        >
          <div
            className="mx-auto w-full max-w-lg animate-fade-up rounded-[1.75rem] border border-line bg-raised px-5 py-9 shadow-soft"
